...
`agent.tlsFiles.caPath` | Path to local file containing the agent's CA certificate(s) | `null`
...
`server.tlsFiles.caPath` | Path to local file containing the server's CA certificate(s) | `null`
